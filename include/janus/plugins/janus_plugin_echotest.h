...
namespace Janus {
  ...
  class JanusPluginEchotest : public JanusPlugin {
    public:
      JanusPluginEchotest(const std::shared_ptr<PluginCommandDelegate>& delegate, const std::shared_ptr<PeerFactory>& peerFactory, const std::shared_ptr<Protocol>& owner) : JanusPlugin(delegate, peerFactory, owner) {}
